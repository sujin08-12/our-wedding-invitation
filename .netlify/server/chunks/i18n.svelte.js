import { V as derived$1 } from "./index.js";
...
registerLocaleLoader("kr", () => import("./kr.js"));
...
class LocaleStore {
  isLoading = true;
  locale = void 0;
  #isKr = derived$1(() => this.locale === "kr");
  get isKr() {
    return this.#isKr();
  }
  set isKr($$value) {
    return this.#isKr($$value);
  }
  #isEn = derived$1(() => this.locale === "en");
  get isEn() {
    return this.#isEn();
  }
  set isEn($$value) {
    return this.#isEn($$value);
  }
  constructor() {
    $isLoading.subscribe((isLoading2) => {
      this.isLoading = isLoading2;
    });
    $locale.subscribe((locale2) => {
      if (locale2 && !["kr", "en"].includes(locale2)) {
        this.locale = "kr";
      } else {
        this.locale = locale2;
      }
